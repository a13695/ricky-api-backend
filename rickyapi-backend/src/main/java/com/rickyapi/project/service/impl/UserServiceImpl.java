...
import static com.rickyapi.project.constant.UserConstant.ADMIN_ROLE;
import static com.rickyapi.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "ricky";
    ...
    @Override
    public boolean updateAkSk(Long id) {
        if(id == null){
